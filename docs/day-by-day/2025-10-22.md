...
**`storage_client.py`** - Abstração de storage
```python
class StorageClient:
...
#### Problema 2: Timezone UTC vs Brazil ✅
...
**Sintoma:**
```
EndpointConnectionError: Could not connect to the endpoint URL: "http://localhost:9000"
[Errno 111] Connection refused
```

**Causa Raiz:**
- Airflow worker container tentando conectar em `localhost:9000`
...
MINIO_ENDPOINT=localhost:9000           # For host machine
